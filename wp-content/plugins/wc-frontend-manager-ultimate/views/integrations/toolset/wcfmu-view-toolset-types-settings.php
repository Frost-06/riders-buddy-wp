...
<div class="wcfm-container">
	<div id="wcfm_toolset_settings_form_pages_expander" class="wcfm-content">
		...
		?>
				<p class="wcfm_title catlimit_title"><strong><?php echo $product_type_label . ' ';
																_e('Field Groups', 'wc-frontend-manager'); ?></strong></p><label class="screen-reader-text" for="product_type_toolset_fields"><?php echo $product_type_label . ' ';
																																																									_e('Field Groups', 'wc-frontend-manager'); ?></label>
				<select id="wcfm_product_type_toolset_fields_<?php echo $product_type; ?>" name="wcfm_product_type_toolset_fields[<?php echo $product_type; ?>][]" class="wcfm-select wcfm_ele wcfm_product_type_toolset_fields" multiple="multiple" data-catlimit="-1" style="width: 60%; margin-bottom: 10px;">
					...
					?>
							<option value="<?php echo $field_group_list_slug; ?>" <?php if (in_array($field_group_list_slug, $product_type_filed_groups)) {
