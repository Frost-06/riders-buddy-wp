...
<div id="wcfm_membership_container">
	<div class="wcfm_membership_thankyou_content_wrapper">
		<?php if (($required_approval != 'yes') && wcfm_is_vendor($member_id)) { ?>
			...
			<a class="wcfm_submit_button wcfm_registration_thank_you_setup_button" href="<?php echo esc_url(apply_filters('wcfm_thank_you_right_button_url', get_wcfm_settings_url(), $member_id)); ?>"><?php echo esc_html(apply_filters('wcfm_thank_you_right_button_label', __('Setup your store', 'wc-multivendor-membership'), $member_id)); ?> >></a>
			<div class="wcfm-clearfix"></div>
		<?php } else { ?>
			<div class="wcfm_membership_thankyou_content">
