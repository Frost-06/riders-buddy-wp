...
if (!$global_subscription_thankyou_content) {
	$global_subscription_thankyou_content = "<strong>Welcome,</strong>
																		<br /><br />
																		You have successfully submitted your Merchant Account request. 
																		<br /><br />
																		Your Merchant application is still under review.
																		<br /><br />
...
<div class="collapse wcfm-collapse">
	<div class="wcfm-page-headig">
		...
		<span class="wcfm-page-heading-text"><?php esc_html_e('Manage Membership', 'wc-multivendor-membership'); ?></span>
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			<h2><?php if ($membership_id) {
					esc_html_e('Edit Membership', 'wc-multivendor-membership');
				} else {
					esc_html_e('Add Membership', 'wc-multivendor-membership');
				} ?></h2>

			<?php
			echo '<a class="wcfm_gloabl_settings text_tip" href="' . esc_url(get_wcfm_memberships_settings_url()) . '" data-tip="' . esc_html(__('Settings', 'wc-frontend-manager')) . '"><span class="wcfmfa fa-cog"></span></a>';
			echo '<a id="add_new_Membership_dashboard" class="add_new_wcfm_ele_dashboard text_tip" href="' . esc_url(get_wcfm_memberships_url()) . '" data-tip="' . esc_html(__('Memberships', 'wc-multivendor-membership')) . '"><span class="wcfmfa fa-user-plus"></span><span class="text">' . esc_html(__('Memberships', 'wc-multivendor-membership')) . '</span></a>';
		...
		<form id="wcfm_memberships_manage_form" class="wcfm">
			...
			<div class="wcfm-tabWrap">
				...
				<div class="wcfm-container">
					<div id="memberships_features_manage_expander" class="wcfm-content">
						...
						if (!empty($membership_feature_lists)) {
							...
							echo esc_html(__('First setup membership basic settings', 'wc-multivendor-membership')) . ' <a href="' . esc_url(get_wcfm_memberships_settings_url()) . '">' . esc_html(__('here', 'wc-multivendor-membership')) . '</a>.';
						}
						if (!$has_feature) {
							echo esc_html(__('Define feature list from membership basic settings', 'wc-multivendor-membership')) . ' <a href="' . esc_url(get_wcfm_memberships_settings_url()) . '">' . esc_html(__('here', 'wc-multivendor-membership')) . '</a>.';
						}
						?>
					</div>
				</div>
				...
				<div class="page_collapsible" id="memberships_subscription_manage_head">
					...
					<?php esc_html_e('Subscription', 'wc-multivendor-membership'); ?>
				</div>
				<div class="wcfm-container">
					<div id="memberships_subscription_manage_expander" class="wcfm-content">
						...
						<div class="wcfm_subs_fields subscription_options">
							...
							<div class="subscription_recurring_options">
								...
								?>
								<div class="wcfm_clearfix"></div>
								<h2><?php esc_html_e('Trial Billing Details (Leave empty if you are not offering a trial period)', 'wc-multivendor-membership'); ?></h2>
								<div class="wcfm_clearfix"></div>
								<?php
								...
								?>
								<div class="wcfm_clearfix"></div>
								<h2><?php esc_html_e('Billing Details', 'wc-multivendor-membership'); ?></h2>
								<div class="wcfm_clearfix"></div>
								<?php
				...
				<div class="page_collapsible" id="memberships_commission_manage_head">
					...
					<?php esc_html_e('Approval', 'wc-multivendor-membership'); ?>
				</div>
				<div class="wcfm-container">
				...
				<div class="page_collapsible" id="memberships_approval_manage_head">
					...
					<?php esc_html_e('Commission', 'wc-multivendor-membership'); ?>
				</div>
				<div class="wcfm-container">
				...
				<div class="page_collapsible" id="memberships_groups_manage_capability_head">
					...
					<?php esc_html_e('Capability', 'wc-multivendor-membership'); ?>
				</div>
				<div class="wcfm-container">
					<div id="memberships_groups_manage_capability_expander" class="wcfm-content">
						<h2><?php esc_html_e('Capability Controller', 'wc-multivendor-membership'); ?></h2>
				...
				<?php if (apply_filters('wcfm_is_pref_vendor_badges', true)) { ?>
					<div class="page_collapsible" id="memberships_badges_manage_head">
						...
						<?php esc_html_e('Badges', 'wc-multivendor-membership'); ?>
					</div>
					<div class="wcfm-container">
			...
			<div id="wcfm_Membership_manager_submit" class="wcfm_form_simple_submit_wrapper">
				...
				<input type="submit" name="membership-manager-data" value="<?php esc_html_e('Submit', 'wc-frontend-manager'); ?>" id="wcfm_Membership_manager_submit_button" class="wcfm_submit_button" />
			</div>
			<?php
