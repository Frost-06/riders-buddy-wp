...
function custom_api_wp_delete_api($api11)
{
    ...
    // echo '<div class = "update notice" style="margin-left:3px"> <p>API Deleted Sucessfully</p> </div>';
                    ...
                    <div class="col-md-8 mo_custom_api_page_layout" style="padding: 15px 25px 25px 25px;margin-left:3px">
                        <form method="POST">
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-6'>
                                    <input type="text" class="mo_custom_api_SelectColumn mo_custom_api_name" id="ApiName" name="ApiName" <?php echo "value = '{$api1}'"; ?> readonly>
                                </div>
                            </div>
                            <br>
                            <div class='row'>
                                ...
                                <?php
                                    if (get_option('CUSTOM_API_WP_LIST')) {
                                        ...
                                        foreach ($list as $key => $value) {
                                            echo "<tr>";
                                            echo "<td class='mo_custom_api_list_api_name'>" . $key . "</td>";
                                            echo "<td>  <button class='mo_custom_api_action_button' onclick = 'custom_api_wp_edit(this)'><b>Edit</b><i class='fas fa-user-edit'></i></button>&nbsp
                                                        ...
                                                        <button class='mo_custom_api_action_button' onclick = 'custom_api_wp_view(this)'><b>View</b><i class='fas fa-user-edit'></i></button>
                                                  </td>";
                                        }
                                    }
                                ?>
            ...
            <div class="box-body">
	            <div class="row mo_custom_api_page_layout_row">
                    <div class="col-md-8 mo_custom_api_page_layout" style="margin-left:3px;padding-left: 25px;padding-top: 20px;">
                        <h5><?php echo " <span style='color:green;font-weight:700'>{$MethodName}</span> /{$ApiName}"; ?></h5>
                        <p style="margin-top:20px;">
                            <div class="mo_custom_api_method_name"><?php echo "{$MethodName}"; ?></div>
                            <input id="copy_text" class="mo_custom_api_display" value='<?php echo "{$ApiDisplay}" ?>' readonly>
                            <button onclick="mo_custom_api_copy_icon()" style="border: none;background-color: white;outline:none;"><img style="width:25px;height:25px;margin-top:-6px;"  src="<?php echo plugin_dir_url(__FILE__); ?>/images/copy3.png"></button>
                        </p>
                        ...
                        <div class="mo_custom_api_view_api_table">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Curl</td>
                                        <td>curl -X GET <?php echo "$ApiDisplay" ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <?php $api=get_site_url();?>
                        <form action="<?php echo "$api" ?>/wp-admin/admin.php?page=custom_api_wp_settings&action=edit&api=<?php echo "$ApiName" ?>" method="POST">
                    ...
                    <div class="col-md-8 mo_custom_api_page_layout" style="padding: 30px">
                        ...
                        <div class="row" style="margin-top: 20px;">
                            ...
                            <div class="col-md-8">
                                ...
                                <img id="show_btn" style="height:20px;width:20px;margin-left:-45px;" src="<?php echo plugin_dir_url(__FILE__); ?>/images/eye.png">
                                <br><br>
                                <button class="mo_custom_api_button" style="width:135px; padding:4px;"><a id="regeneratetoken" name="action" ><h6 style="font-size:14px">Generate New Key</h6></a></button>
                                <br>
                            </div>
                        </div>
                        <hr class="mo_custom_api_hr">
                    ...
                    <div class="col-md-8 mo_custom_api_page_layout" style="padding:30px;padding-top: 15px;">
                        ...
                        <form id="custom_api_wp_sql" method="post">
                            ...
                            <div class=row>
                                ...
                                <div class=col-md-6>
                                    <textarea id="customsql" name="customsql" rows=10  style="width: 80%; line-height: 18px; font-size: 20px;" required></textarea>
                                </div>
                            </div>
                            <hr class="mo_custom_api_hr">
                            ...
                            <div class=row>
                                ...
                                <div class=col-md-6>
                                    <textarea id="customsql" name="customsql" rows=10 style="width: 80%; line-height: 18px; font-size: 20px;">
                                        <?php echo esc_attr($selectedsql['sql_query']) ?>
                                    </textarea>
                                </div>
                            </div>
                            <hr class="mo_custom_api_hr">
        ...
        <div class="wrap mo_custom_api_page_layout_wrap" style="margin-left:18px">
                                                ...
                                                <?php
                                                    if (get_option('custom_api_wp_sql')) {
                                                        ...
                                                        foreach ($list as $key => $value) {
                                                            echo "<tr>";
                                                            echo " <td class='mo_custom_api_list_api_name'>" . $key . "</td>";
                                                            echo "<td> <button class='mo_custom_api_action_button' onclick = 'custom_api_wp_edit_sql(this)'>Edit<i class='fas fa-user-edit'></i></button>&nbsp
                                                                        <button class='mo_custom_api_action_button' onclick ='custom_api_wp_delete_sql(this)'>Delete<i class='fas fa-user-edit'></i></button>&nbsp
                                                                </td>";
                                                        }
                                                    } 
                                                ?>
            ...
            <div class="box-body">
	    		<div class="row mo_custom_api_page_layout_row">
                    ...
                    <hr>
                      <h6 style="margin-bottom:18px;">You have not created any custom sql API, to start <a class="mo_custom_api_ext_btn" href="admin.php?page=custom_api_wp_settings&action=customsql"> Click here</a></h6>
                      <p><strong>Notice: </strong><span style="color:red">*</span>With the current plan of the plugin you can create only one custom sql API, to create more, upgrade to <a href="admin.php?page=custom_api_wp_settings&action=license"><strong>Enterprise</strong></a> plan.</p>
                      </div>
                      <?php contact_form();
                      mo_custom_api_advertisement(); ?>
    ...
    <div class="wrap" style="margin-top:5px;">
        <div class="box-body">
            ...
            <div class=row>
                ...
                <div class=col-md-6>
                    <input type="text" id="ExternalApi" class="mo_custom_api_custom_field" name="ExternalApi"  placeholder="Enter External API" value=<?php echo isset($ExternalApiConfiguration["ExternalEndpoint"]) ? html_entity_decode(esc_attr($ExternalApiConfiguration["ExternalEndpoint"])) : ""; ?> >
                </div>
        ...
        echo 'style="display: block; "';
                ...
                <div class=col-md-5 id="RequestBodyJsonTextArea" <?php if (isset($ExternalApiConfiguration["ExternalApiBodyRequestType"]) && $ExternalApiConfiguration["ExternalApiBodyRequestType"] == "json") {echo 'style="display: block; "';} else {echo 'style="display: none; "';} ?>>
                    <textarea id="RequestBodyJson" name="RequestBodyJson" style="height:123px;width:50%"><?php if (isset($ExternalApiConfiguration["ExternalApiBodyRequestType"]) && $ExternalApiConfiguration["ExternalApiBodyRequestType"] == "json") {echo esc_attr($ExternalApiConfiguration["ExternalApiPostField"]);} ?></textarea>
                </div>
...
function custom_api_test_execute(){
    var myWindow = window.open('<?php echo site_url(); // phpcs:ignore WordPress.Security.EscapeOutput?>' + '/wp-admin/?customapiexternal=testexecute', "Test Attribute Configuration", "width=600, height=600");
}
</script>
<input type="button" id="dynamic_external_ui" name="dynamic_external_ui" style="display:none;" onclick = '<?php
if (isset($ExternalApiConfiguration["ExternalHeaders"]) && isset($ExternalApiConfiguration["ExternalApiPostField"]) && isset($ExternalApiConfiguration["ExternalApiBodyRequestType"])) {
        echo 'add_dynamic_externalapi_ui(';
        echo json_encode($ExternalApiConfiguration["ExternalHeaders"]);
        echo ",";
        if ($ExternalApiConfiguration["ExternalApiBodyRequestType"] != 'json') {
            echo '"' . esc_attr($ExternalApiConfiguration["ExternalApiPostField"]) . '"';
        } else {
            echo esc_attr($ExternalApiConfiguration["ExternalApiPostField"]);
        }
        echo ",";
        echo '"' . esc_attr($ExternalApiConfiguration["ExternalApiBodyRequestType"]) . '"';
        echo ")";
    } ?> '>
        ...
        <div class="wrap mo_custom_api_page_layout_wrap" style="margin-left:18px">
                                                ...
                                                <?php
                                                    if (get_option('custom_api_save_ExternalApiConfiguration')) {
                                                        ...
                                                        foreach ($list as $key => $value) {
                                                            echo "<tr>";
                                                            echo "<td class='mo_custom_api_list_api_name'>" . $key . "</td>";
                                                            echo " <td style='color:#36B37E;font-size:17px;font-weight:700'>" . $value["ExternalApiRequestType"]. "</td>";
                                                            echo "<td>  <button class='mo_custom_api_action_button' onclick = 'editexternalapi(this)'><b>Edit</b><i class='fas fa-user-edit'></i></button>&nbsp
            ...
            <div class="box-body">
	    		<div class="row mo_custom_api_page_layout_row">
                    ...
                    <hr>
                      <h6>You have not integrated any external api, to start intergration <a class="mo_custom_api_ext_btn" href="admin.php?page=custom_api_wp_settings&action=externalapi"> Click here</a></h6><br>
...
<div class="wrap" style="margin-top:5px;">
        <!-- <div class="box-body"> -->
           ...
           <div class=row>
               ...
               <div class=col-md-6>
                   <input type="text" id="ExternalApiName" class="mo_custom_api_custom_field" name="ExternalApiName" value=<?php echo isset($ExternalApiConfiguration["ExternalApiName"]) ? esc_attr($ExternalApiConfiguration["ExternalApiName"]) : "" ?> >
               </div>
           </div>
           <br>
           ...
           <div class=row id="ExternalApiBody">
               ...
               <div class=col-md-3 id = "DivRequestBodyKey" <?php if (isset($ExternalApiConfiguration["ExternalApiBodyRequestType"]) && $ExternalApiConfiguration["ExternalApiBodyRequestType"] == "json") {echo 'style="display: none; "';} else {echo 'style="display: block; "';} ?>>
               <input type="text" id="RequestBodyKey" class="mo_custom_api_custom_field" name="RequestBodyKey" placeholder="Enter Key" value="<?php echo isset($BodyKey) ? esc_attr($BodyKey) : '' ?>">
               ...
               <div class=col-md-6 id="RequestBodyJsonTextArea" <?php if (isset($ExternalApiConfiguration["ExternalApiBodyRequestType"]) && $ExternalApiConfiguration["ExternalApiBodyRequestType"] == "json") {echo 'style="display: block; "';} else {echo 'style="display: none; "';} ?>>
                   <textarea id="RequestBodyJson" name="RequestBodyJson" style="height:123px;width:50%"><?php if (isset($ExternalApiConfiguration["ExternalApiBodyRequestType"]) && $ExternalApiConfiguration["ExternalApiBodyRequestType"] == "json") {echo esc_attr($ExternalApiConfiguration["ExternalApiPostField"]);} ?></textarea>
               </div>
   ...
   <script>
function custom_api_test_execute(){
   var myWindow = window.open('<?php echo site_url(); // phpcs:ignore WordPress.Security.EscapeOutput?>' + '/wp-admin/?customapiexternal=testexecute', "Test Attribute Configuration", "width=600, height=1000");
}
</script>
<input type="button" id="dynamic_external_ui" name="dynamic_external_ui" style="display:none;" onclick = '<?php
if (isset($ExternalApiConfiguration["ExternalHeaders"]) && isset($ExternalApiConfiguration["ExternalApiPostField"]) && isset($ExternalApiConfiguration["ExternalApiBodyRequestType"])) {
	    		...
	    		<div class="row mo_custom_api_page_layout_row">
                    <div class="col-md-8 mo_custom_api_page_layout" style="padding:30px;padding-top: 15px;background-color: #f5f5f5;">
                        ...
                        <div class="mo_custom_api_intg_cards">
                            ...
                            <img src="<?php echo plugin_dir_url(__FILE__); ?>/images/woo-3.png" class="mo_cusotm_api_intg_logo" alt=" Image">
                        ...
                        <div class="mo_custom_api_intg_cards">
                            ...
                            <img src="<?php echo plugin_dir_url(__FILE__); ?>/images/ex3.png" class="mo_cusotm_api_intg_logo" alt=" Image">
                            <span class="mo_custom_api_intg_rect"></span>
                            <span class="mo_custom_api_intg_tri"></span>
                        ...
                        <div class="mo_custom_api_intg_cards">
                            ...
                            <img src="<?php echo plugin_dir_url(__FILE__); ?>/images/sql-1.jpg" class="mo_cusotm_api_intg_logo" alt=" Image">
                            <span class="mo_custom_api_intg_rect"></span>
                            <span class="mo_custom_api_intg_tri"></span>
                        ...
                        <div class="mo_custom_api_intg_cards">
                            ...
                            <img src="<?php echo plugin_dir_url(__FILE__); ?>/images/zoho.png" class="mo_cusotm_api_intg_logo" alt=" Image">
                            <span class="mo_custom_api_intg_rect"></span>
                            <span class="mo_custom_api_intg_tri"></span>
                        ...
                        <div class="mo_custom_api_intg_cards">
                            ...
                            <img src="<?php echo plugin_dir_url(__FILE__); ?>/images/alidropship.png" class="mo_cusotm_api_intg_logo" alt=" Image">
                            <span class="mo_custom_api_intg_rect"></span>
                            <span class="mo_custom_api_intg_tri"></span>
                            <!-- <a class="mo_custom_api_intg_readmore" href="https://plugins.miniorange.com/wordpress-user-provisioning" target="_blank">Learn More</a> -->
                        </div>
                        ...
                        <div class="mo_custom_api_intg_cards">
                            ...
                            <p class="mo_custom_api_intg_para">If you have a Woocommerce store and want to call the external/3rd-party provider APIs on various Woocommerce events like product purchase, order created, order status update, order whishlisted etc, then using the plugin's Connect to External API feature and developer hooks, this can be integrated.</p>
                            <img src="<?php echo plugin_dir_url(__FILE__); ?>/images/woo-3.png" class="mo_cusotm_api_intg_logo" alt=" Image">
                            <span class="mo_custom_api_intg_rect"></span>
                            <span class="mo_custom_api_intg_tri"></span>
                            <!-- <a class="mo_custom_api_intg_readmore" href="https://plugins.miniorange.com/woocommerce-api-product-sync-with-woocommerce-rest-apis" target="_blank">Learn More</a> -->
