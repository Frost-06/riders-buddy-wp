...
function custom_api_authentication_licensing_page()
{
    ?>
        ...
        <form style="display:none;" id="loginform" action="<?php echo get_option('host_name') . '/moas/login'; ?>" target="_blank" method="post">
        ...
        <form style="display:none;" id="viewlicensekeys" action="<?php echo get_option('host_name') . '/moas/login'; ?>" target="_blank" method="post">
            <input type="email" name="username" value="<?php echo get_option('custom_api_authentication_admin_email'); ?>"/>
                    ...
                    <div class="row justify-content-center mx-15">
                        ...
                        <div class="row">
                            ...
                            <div class="mo_custom_api_licensing_plan card-body">
                                    ...
                                    <button class="mo_custom_api_license_button" onclick="upgradeform2()">Contact Us</button>
                        ...
                        <div class=mo_custom_api_licensing>
                            ...
                            <br>
                            <br>
                            At miniOrange, we want to ensure you are 100% happy with your purchase. If the premium plugin you purchased is not working as advertised and you've attempted to resolve any issues with our support team, which couldn't get resolved. Please email us at <a href="mailto:info@xecurify.com?subject=Custom API for WP - Enquiry">info@xecurify.com</a> for any queries regarding the return policy.
                            <br>
                            <br>
                            <br>
                        </div>
