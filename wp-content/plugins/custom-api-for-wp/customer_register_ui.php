	    					...
	    					<div id="panel1">
	    						...
	    						<table style="margin-left:-10px;" class="mo_custom_api_account_setup_form">
	    							<tr>
	    								...
	    								<td>
	    									<input class="register_ui_input" type="email" name="email" style="width: 150%;" required placeholder="person@example.com" value="<?php echo get_option('custom_api_authentication_admin_email'); ?>" />
	    								</td>
	    							</tr>
	    							<tr class="hidden">
	    								<td><b><font color="#FF0000">*</font>Website/Company Name:</b></td>
	    								<td>
	    									<input class="" type="text" name="company" required placeholder="Enter website or company name" value="<?php echo $_SERVER['SERVER_NAME']; ?>" />
	    								</td>
	    							</tr>
	    							<tr class="hidden">
	    							...
	    							<tr>
	    								...
	    								<td>
	    									...
	    									<input type="button" name="custom_api_goto_login" id="custom_api_goto_login" style="color:white;width: 170px" value="Already have an account?" class="mo_custom_api_button" />&nbsp;&nbsp;
	    								</td>
	    							</tr>
	    						</table>
	    					</div>
	    	...
	    	<div class="mo_custom_api_support_layout">
	    		<div>
					...
					<?php wp_nonce_field('mo_custom_api_submit_contact_us', 'mo_custom_api_submit_contact_us_field');?>
	    				...
	    				<br>
	    				<p style="font-size: 13px;font-weight: 500;">If you want custom features in the plugin, just drop an email at <a href="mailto:info@xecurify.com?subject=Custom API for WP - Enquiry">info@xecurify.com</a>.</p>
	    			</form>
	    		</div>
	    	</div>
	    <!-- </div> -->
	    					...
	    					<div id="panel1">
	    						<table class="mo_custom_api_account_setup_form">
	    							<tr style="border-sapciing:20px;">
	    								<td><b><font color="#FF0000">*</font>Email:</b></td>
	    								<td><input class="register_ui_input" style="width: 100%;" type="email" name="email" required placeholder="person@example.com" value="<?php echo get_option('custom_api_authentication_admin_email'); ?>" /></td>
	    							</tr>
	    							<tr>
	    							    <td><b><font color="#FF0000">*</font>Password:</b></td>
	    					...
	    					<tr>
	    						<td>
									...
									<?php wp_nonce_field("mo_custom_api_goto_login_form","mo_custom_api_goto_login_form_field")?>
	    								...
	    								<input type="submit" value="Change Account" style="width: 120px;" class="mo_custom_api_button" />
	    							</form>
	    						</td>
	    					</tr>
	    				</table>
