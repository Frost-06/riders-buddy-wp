	...
	<form method="post" action="options.php" novalidate="novalidate">
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				...
				<td><input name="new_admin_email" type="email" id="new_admin_email" aria-describedby="new-admin-email-description" value="ridersbuddy.ph@gmail.com"" class=" regular-text ltr" />
